    ...
    farmerApi
      ...
      .then((res) => {
        if (isMounted) {
          ...
          // Fetch marketplace data after profile is loaded
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs flex flex-col justify-between">
                ...
                <Link to="/marketplace/intelligence" className="block text-center text-xs font-semibold text-blue-700 bg-blue-50 hover:bg-blue-100 border border-blue-200 px-3 py-2 rounded-lg transition-colors mt-4 pt-4 border-t-slate-100">
                  View All Prices →
                </Link>
              </div>
